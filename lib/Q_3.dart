            ...
            child: Container(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  alignment: Alignment.center,
                  decoration: const BoxDecoration(
                    border: Border(bottom: BorderSide(color:Color(0xffE91E63),width: 45),right:BorderSide(color:Color(0xffE91E63),width: 45)),
                  ),
                  child: Container(
                    alignment: Alignment.center,
                    decoration: const BoxDecoration(
                    border: Border(bottom: BorderSide(color:Color(0xffFF9800),width: 35),right:BorderSide(color:Color(0xffFF9800),width: 35)),
                    ),
                    child: Container(
                      alignment: Alignment.center,
                      decoration: const BoxDecoration(
